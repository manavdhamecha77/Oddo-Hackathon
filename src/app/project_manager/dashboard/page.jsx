    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">Project Manager Dashboard</h1>
          <p className="text-sm sm:text-base text-muted-foreground">Welcome back, {user?.name}! Manage your projects and team.</p>
        </div>
      ...
      <div className="bg-card border rounded-xl">
        <div className="p-4 sm:p-6 border-b flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <Button variant="outline" size="sm" asChild className="w-full sm:w-auto">
            <Link href="/project_manager/dashboard/projects">View All</Link>
          </Button>
        </div>
        {projects.length === 0 ? (
